...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.noViewModel).setOnClickListener {
            startActivity(Intent(this, NoViewModel::class.java))

        }
        findViewById<Button>(R.id.viewModel).setOnClickListener {
            startActivity(Intent(this, ViewModel::class.java))

        }
        findViewById<Button>(R.id.liveData).setOnClickListener {
